...
class PUTestPaymentProfile extends PHPUnit_Framework_TestCase {
	public function dataPayecoCallback(){
		...
		$valid_union_pay_order_input = array(
            ...
            "Remark" => "交易成功",
            "TerminalNo" => "02028828",
            "MerchantNo" => "02502020000674",
            "OrderNo" => "26DD1112577|502013091147478441",
            "OrderState" => "02",
            "Description" => "购买道具",
            "ValidTime" => "20130918130857",
            "OrderType" => "00",
            "TransData" => "|||01|未知|10.1.8.1|||||",
            "Mac" => "7064B250FC7B3AD885BB4DBF416ECA81"
            /*
            'ProcCode' => '0210',
            'AccountNum' => '04',
            'ProcessCode' => '190000',
