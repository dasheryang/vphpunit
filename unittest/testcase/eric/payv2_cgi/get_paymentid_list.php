...
class PUTestPaymentPList extends PHPUnit_Framework_TestCase {
	...
	public function dataCGIPaymentProfilePList(){
        ...
        $params = 'auth_game_type=&nudid=921_944195295208108sqs90n3p1q3584&p_list=0147&sim=1&pay=4&
        cli_ver=201309162030&app_key=299b87b58809e7ef06d9&debug=2&udid=00000000-4dec-0790-ffff-ffffc7eb5e5f&
        channel_id=TEST0000000'; //ip=122.157.20.217
		return array(
			array(
					"http://{$target_domain}/get_paymentid_list?{$params}",
