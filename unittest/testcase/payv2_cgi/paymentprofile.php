...
class PUTestPaymentProfile extends PHPUnit_Framework_TestCase {
	public function dataCGIPaymentProfile(){
		...
		return array(
			array(
					"http://{$target_domain}/paymentprofile?game_id=10060&channel_id=&type=0&pack_ver=1&isadmin=1",
					array( 'field_count_least' => 4 ),
					'测试游戏10060',
			),
            array(
	                "http://{$target_domain}/paymentprofile?game_id=10058&channel_id=&type=1&pack_ver=1&isadmin=1",
	                array( 'field_count_least' => 4 ),
	            	'测试游戏10058',
            ),
		);
