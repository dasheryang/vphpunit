...
class SmsVerifyTest extends PHPUnit_Framework_TestCase {
	 ...
	 */
	function testSmsVerify( $target_domain, $udid, $phone, $verify_type, $desc ) {
		$target_cgi = "http://{$target_domain}/account/sms_verify?udid=$udid&phone=$phone&verify_type=$verify_type";
		echo $target_cgi . "\r\n";
		$ch = curl_init();
