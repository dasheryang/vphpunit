...
class PUTestBindMobile extends PHPUnit_Framework_TestCase {
    public function dataCGI(){
        ...
        //MM 支付测试
        $test_case = array(
                'cgi' => "http://{$target_domain}/bind_mobile",
                'get' => array(
                    'token' => '006b372e23d8895d6bc419a042cfe0be05406b91f', //身份凭证
                    'verify_code'  => '6443', //type 类型 1:register,用户注册;2:bindPhone,绑定手机;3:getPassword,找回密码
     ...
     */
    public function testCGIBindMobile( $str_target_cgi, $post_arr, $url, $expect_result, $desc = '' ){
        $obj_curl = curl_init();
