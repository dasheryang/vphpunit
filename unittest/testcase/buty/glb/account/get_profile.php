...
class PUTestGetProfile extends PHPUnit_Framework_TestCase {
    public function dataCGI(){
        ...
        //MM 支付测试
        $test_case = array(
                'cgi' => "http://{$target_domain}/get_profile",
                'post' => array(
     ...
     */
    public function testCGIGetProfile( $str_target_cgi, $post_arr, $url, $expect_result, $desc = '' ){
        $obj_curl = curl_init();
