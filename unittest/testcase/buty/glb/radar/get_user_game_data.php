...
class PUTestGetUserGameData extends PHPUnit_Framework_TestCase {
    public function dataCGI(){
        ...
        //MM 支付测试
        $test_case = array(
                'cgi' => "http://{$target_domain}/radar/get_user_game_data",
                'post' => array(
     ...
     */
    public function testCGIGetUserGameData( $str_target_cgi, $post_arr, $url, $expect_result, $desc = '' ){
        $obj_curl = curl_init();
