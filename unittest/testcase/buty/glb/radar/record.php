...
class PUTestRecord extends PHPUnit_Framework_TestCase {
     ...
     */
    public function testCGIRecord( $str_target_cgi, $post_arr, $url, $expect_result, $desc = '' ){
        $obj_curl = curl_init();
